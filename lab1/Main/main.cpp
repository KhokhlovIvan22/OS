...
int main() {
    ...
    wstring countW = to_wstring(recordCount);
    {
        ...
        if (!CreateProcess(nullptr, cmd1, nullptr, nullptr, FALSE,  0,  nullptr, nullptr, &si1, &pi1))
        {
    ...
    wstring hourlyRateW = to_wstring(hourlyRate);
    {
        ...
        if (!CreateProcess(nullptr,cmd2, nullptr, nullptr, FALSE, 0, nullptr, nullptr, &si2, &pi2))
        {
